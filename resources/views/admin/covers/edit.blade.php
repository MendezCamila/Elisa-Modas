...
<form action="{{ route('admin.covers.update', $cover) }}" method="POST" enctype="multipart/form-data">
    ...
    <figure class="relative mb-4">
        ...
        <img src="{{ $cover->image }}" alt="Portada" class="w-full aspect-[3/1] object-cover object-center" id="imgPreview">
    </figure>
    ...
    <div class="mb-4 flex space-x-2">
        <label>
            <x-input type="radio" name="is_active" value="1" class="mr-2" :checked="$cover->is_active == 1" />
            Activo
        </label>
        <label>
            <x-input type="radio" name="is_active" value="0" class="mr-2" :checked="$cover->is_active == 0 " />
            Inactivo
        </label>
    </div>
