    ...
    <x-container class="px-4 my-4">
        <nav class="flex" aria-label="Breadcrumb">
            ...
            <li>
                ...
                <a href="{{ route('families.show',$category->family) }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-pink-600 md:ms-2 dark:text-gray-400 dark:hover:text-pink">
